...
-- ---------- الأعلى تقييماً ----------
-- متوسط بايزي لا متوسط حسابي: عمل بتقييم واحد ٥/٥ لا يتصدّر على عمل
-- بأربعين تقييماً معدّلها ٤٫٦. الوزن m=3 يعني أن العمل يحتاج ثلاثة
-- تقييمات ليقترب من متوسطه الحقيقي، وقبلها يُسحَب نحو متوسط الموقع.
--
-- جدول ratings مقروء للجميع أصلاً (سياسة "read all ratings")، فالدالة
-- security invoker — لا تتجاوز أي صلاحية.
