-- ============================================================
--  ٨٤ — talk_spoiler · «رسالتي فيها حرق» (D-271)
--  ⚠️ **وكُتب هنا `D-268` سهواً أوّلَ مرّة** — وذاك رقمُ رموزِ الأقسام
--  الملوّنة. **والرقمُ الصحيح D-271**، وهو ما كتبته الشيفرةُ في `src/`.
