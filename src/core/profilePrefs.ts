...
export const DEFAULT_PROFILE_PREFS: ProfilePrefs = {
  ...
  /* ⚖️ 🆕 **الترتيبُ الافتراضيُّ بحكم أحمد** (D-941b، بلقطةٍ على ورقة الترتيب:
     «خلّ الأنمي الثالث وأظهره، خلّ القوائم الخامس، أظهر الممثّلين»): **«فنّانوك»
     دخل الافتراضيَّ لأوّل مرّة** — حجّةُ إبعاده («تكلّف نداءاتِ TMDB لعدّ
     الأعمال») سقطت مع سقوط العدّ نفسِه (D-128: الصفُّ بلا سطرِ «شاهدتَ له ٧
     أعمال»)، **فلم يبقَ للإبعاد سبب.** */
  order: ["shows", "movies", "anime", "ratings", "lists", "artists"],
  density: "comfortable",
  cards: "full",
