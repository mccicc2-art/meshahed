...
export const TOP_LISTS: Universe[] = [
  ...
  /* ⚖️ 🆕 **والأنمي بلا رقمٍ في اسمه** (D-393، حكمُ أحمد): **٢٢٧ عملاً
     ولن تبلغ ٢٥٠** — الباقي غيرُ موجودٍ في IMDb فوق العتبة (D-382/D-385).
     **والرقمُ في الاسم وعدٌ لا عدّ** (D-219/D-340)، **والسلغُ لم يتغيّر**
     لأنه هويّةٌ لا عنوان (D-328): القائمةُ المولَّدةُ نفسُها، واسمُها
     وحدَه تبدّل. */
  { slug: "top250-anime", ar: "أفضل الأنمي", en: "Top Anime", top: "anime" },
];
...
export const FRANCHISES: Franchise[] = [
  /* ⚖️ D-1008 (١٧ سبتمبر ٢٠٢٦) — **الجوائزُ أوّلُ الصفوف وTOP بعدها** بقرار أحمد («خلّ awards
     فوق Top»)؛ كان TOP أوّلاً منذ طلبه الأسبق (مرجعُ الجودة قبل العوالم). صفّ الجوائز:
     بطاقةٌ لكلِّ جائزة — الفائزون مرتّبين بالأحدث، وسنةُ الفوز على الملصق (D-995). */
  {
    slug: "awards",
    ar: "الجوائز",
    en: "Awards",
  ...
  {
    slug: "top250",
    /* ⚖️ 🆕 **ورأسُ الرفّ بلا رقمٍ كذلك** (D-393): رفٌّ اسمُه «TOP 250»
       وفيه بطاقةٌ تقول «أفضل الأنمي» **يَعِد رقماً لا تعطيه إحدى
       بطاقاته** — **والرأسُ يَعِد بما تحته كلِّه** (D-181/D-363). */
    ar: "الأفضل",
    en: "TOP",
    sets: ["top250-movies", "top250-shows", "top250-anime"].map(bySlug),
  },
  /* ⚖️ D-1007 (١٧ سبتمبر ٢٠٢٦) — **صفُّ «قوائم مشهورة» حُذف من «اكتشف» بقرار أحمد**
     («Famous lists احذفها — هي فقط»). القوائمُ نفسُها (`FAMOUS_LISTS`: AFI 100 ·
     Sight & Sound) تبقى أعوالمَ لها صفحاتُها وروابطُها ومن حفظها — الصفُّ وحدَه غاب. */
  {
    slug: "marvel",
    ar: "عالم مارفل",
    en: "Marvel",
