...
/* 🗑️ **سجلُّ لون التمييز الشخصيِّ سقط بكامله** (D-848، حكمُ أحمد
   ...
   **كان `ACCENTS` وثمانيَ دوائرَ و`themeAccent`/`accentVars`/`accentCss`
   و`isThemeAccent`** — **لونٌ يركب فوق أيِّ ثيمٍ ويعبر إلى زائر ملفّك**
   (D-825 · الهجرة ١٦٣).

   🔑 **والحجّةُ التي أسقطته**: **صار للتطبيق مصدران للّون الواحد** —
   **الثيمُ يقول `--accent` وهذا يكتبه فوقه** — **وكلُّ قرارٍ في اللون
   بعدها يسأل «أيّهما يفوز؟».** ⚖️ **وهو نقضٌ صريحٌ لـD-825 بيد
   صاحبها**، **وسؤالُها المفتوح «شريطُ التقدّم هويّةٌ أم واجهة؟» يسقط
   معها.**

   ⚠️ **والثيماتُ كلُّها باقيةٌ كما هي** — **الذي سقط هو ما يركب
