...
export const TAB_SURFACES: Record<TabSurface, SurfaceSpec> = {
  ...
  /* ⚖️ 🆕 **المسلسلات أوّلاً ثم الأفلام** (D-602، حكمُ أحمد ٢٥ أغسطس:
     «مسلسلات ثم أفلام — الكل حتى اكتشف») — **القلبةُ الثالثةُ لهذا
     الترتيب بأمره وتُسجَّل كلُّها**: أفلامٌ في ٩ أغسطس، مسلسلاتٌ في
     ١١، أفلامٌ في ١٢ («رجوعٌ إلى الأصل»)، ومسلسلاتٌ اليوم — **توحيداً
     مع البروفايل والرئيسية** اللذين كانا مسلسلات-أوّلاً أصلاً، فصار
     المعيارُ واحداً في كلِّ السطوح. في اكتشف والمكتبة معاً، فلا تختلف
     الصفحتان في ترتيبٍ واحد.
     **وهذا ترتيبُ الافتراض لا أمرٌ نهائيّ:** من رتّبها بنفسه يبقى على
     ترتيبه، لأن القارئ يقرأ الكوكي قبل أن يقرأ هذه القائمة —
     **فمن عكسها بيده لن يرى هذا التوحيد**، ويعيدها بسهمين. */
  discover: {
