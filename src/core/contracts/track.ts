 ...
 * `startRewatch` في `actions.ts`). الشاشةُ الأصليّةُ تنادي الدوالَّ نفسَها
 * بمعرّف المسلسل وحدَه — **لا نسخةَ ثانيةً من حساب «التالية» في العميل** (D-145).
 */
export type ShowRefBody = { showTmdbId: number };
