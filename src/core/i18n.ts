...
const ar = {
  ...
  /* 🆕 D-1014 — صفُّ أفعال صفحة العمل (التطبيق): كلماتٌ قصيرةٌ تسع خُمسَ الشاشة */
  toWatchAction: "للمشاهدة",
  toListAction: "إلى قائمة",
  inListAction: "في قائمة",
  favoriteAction: "مفضّلة",
  watchedAction: "شاهدته",
  ...
  /* ⚖️ 🆕 **والعددُ يوافق معدودَه** (D-723، كشفتْه قائمةُ «بقيّة
     التصنيفات»): **كانت «عملاً» لكلِّ رقم** — **و«١ عملاً» و«٥ عملاً»
     خطآن في العربيّة**، وصوابُهما «عمل» و«أعمال».
     🔑 **ولم يظهرا قبل اليوم لأن البطاقةَ تعرض صفَّين من صدارةٍ
     أرقامُها كبيرة** — **وقاعدةٌ لا تُختبر إلّا بطرفها الأصغر تبقى
     صحيحةً في العرض وخاطئةً في نفسها** حتّى يُفتح بابٌ يعرض الذيل.
     ⚠️ **والمثنّى يبقى ناقصاً**: صوابُ الاثنين «عملان» بلا رقمٍ قبله،
     **والصفُّ يرسم الرقمَ بلونِ الهويّة والوحدةَ بجانبه** (D-703) —
     **فإصلاحُه يقتضي أن يأخذ الصفُّ عبارةً كاملةً لا رقماً ووحدة**،
  ...
  /* 🆕 D-770 (النموذج النهائيّ، نسخ D-768): صفحةُ «الدعوات والمكافآت»
     ...
     وLoopz Partners (طلبٌ → مراجعةٌ → لوحةُ شريكٍ **بلا قسمِ أموالٍ
     حتى يُفتح الدفع** — حكمُه: «بلا قسم الأموال مؤقتاً») */
  setInvites: "الدعوات والمكافآت",
  invTabFriends: "دعوة الأصدقاء",
  invTabPartners: "Loopz Partners",
  invYourLink: "رابط دعوتك",
  invShare: "شارك رابطك",
  invCopy: "نسخ الرابط",
  invNextReward: "مكافأة Loopz+ التالية",
  invOf: "من",
  invQualified: "دعوات محتسبة",
  invStepHintPre: "ادعُ ٥ أصدقاء واكسب",
  invStepHintReward: "شهر Loopz+",
  invStatJoined: "انضمّوا",
  invStatCounted: "احتُسبوا",
  invStatSubscribed: "اشتركوا",
  invStatRewards: "مكافآتك",
  invDayUnit: "يوم",
  invRecent: "آخر الدعوات",
  invViewAll: "عرض الكل",
  invEmptyTitle: "لا دعوات بعد",
  invEmptyBody: "شارك رابطك للبدء",
  invHowTitle: "كيف تعمل المكافآت",
  invHow14: "صديقك يحصل على ١٤ يوم Loopz+",
  invHow7: "تحصل على ٧ أيام حين يصبح نشطاً",
  invHowSub: "وتحصل على ١٤ يوماً إضافية حين يشترك",
  invFinePrint:
    "يصبح صديقك نشطاً بعد متابعة ٥ أعمال ونشاط في ٣ أيام مختلفة خلال أول ١٤ يوماً · مكافأة الاشتراك تُفعَّل مع فتح الاشتراكات · الحد الأقصى ١٢ شهراً في السنة",
  invTermsLink: "الشروط والأهلية",
  invStJoined: "انضمّ",
  invStProgress: "قيد التقدّم",
  invStQualified: "محتسبة",
  ...
  prtHeroBody: "اكسب ٢٥٪ من صافي كلّ دفعة يدفعها من اشترك عبرك — طوال سنته الأولى.",
  ...
  prtStep1: "قدّم",
  prtStep1Sub: "أخبرنا أين تنشر محتواك",
  prtStep2: "الموافقة",
  prtStep2Sub: "نراجع ملفك",
  prtStep3: "شارك واكسب",
  prtStep3Sub: "استخدم رابطك الخاص كشريك",
  prtWhoTitle: "من يمكنه التقديم؟",
  prtWhoHead: "صنّاع المحتوى والمراجعون وأعضاء المجتمع النشطون",
  prtWho1: "حساب Loopz نشط",
  prtWho2: "حساب أو قناة عامة",
  prtWho3: "محتوى ترفيهي أصلي",
  prtReqTitle: "شرطان قبل التقديم",
  prtReqX: "حساب X موثّق في لوبز",
  prtReqPlus: "اشتراك Loopz+ فعّال",
  prtReqGo: "أكمِله ليُفتح باب التقديم",
  prtSetupTitle: "أكمِل بيانات شريكك",
  prtSetupBody: "التحويلات تُفتح مع فتح المدفوعات — وتصل أولاً لمن اكتملت بياناته.",
  prtRowId: "صورة الهويّة",
  prtIdPick: "صورة أو PDF — حتى ٨MB",
  prtIdDone: "مرفوعة — اضغط للاستبدال",
  prtIdBusy: "يرفع…",
  prtIdErrType: "صورة أو PDF فقط",
  prtIdErrSize: "الحدّ ٨MB",
  prtIdErrUp: "تعذّر الرفع",
  prtBankIban: "الآيبان (SA…)",
  prtBankName: "اسم البنك",
  prtBankHolder: "اسم صاحب الحساب",
  prtPhoneField: "رقم الجوال (05…)",
  prtSaveDetails: "احفظ البيانات",
  prtDetailsTitle: "بيانات التحويل",
  prtTermsLink: "شروط الشركاء",
  prtReviewNote: "تُراجع الطلبات فردياً.",
  prtApplyTitle: "طلب الانضمام",
  prtFieldChannel: "رابط قناتك أو حسابك الأساسي",
  prtFieldContent: "نوع المحتوى (مراجعات، أخبار، بودكاست…)",
  prtFieldPlatforms: "المنصات التي تنشر فيها",
  prtFieldFollowers: "عدد المتابعين — اختياري",
  prtFieldCountry: "الدولة",
  prtFieldLanguage: "لغة المحتوى",
  prtFieldReason: "لماذا تريد الانضمام؟",
  prtTermsAgree: "أوافق على شروط برنامج الشركاء",
  prtSubmit: "إرسال الطلب",
  prtUnderReview: "طلبك قيد المراجعة",
  prtReviewBody: "سنبلّغك بالنتيجة هنا فور مراجعته",
  prtAppliedAt: (when: string) => `أُرسل ${when}`,
  prtEdit: "تعديل الطلب",
  prtCancelApp: "سحب الطلب",
  prtRejectedTitle: "لم يُقبل الطلب هذه المرة",
  prtRejectedBody: "يمكنك التقديم من جديد متى تغيّر محتواك أو جمهورك",
  prtYourLink: "رابطك كشريك",
  prtStatClicks: "نقرات",
  prtStatJoined: "انضمّوا",
  prtStatPaid: "اشتركوا",
  prtStatConv: "التحويل",
  prtEarnLabel: "الأرباح المتاحة",
  prtCurrency: "ر.س",
  prtPendingSuffix: "قيد التعليق",
  prtMinPayout: "الحد الأدنى للتحويل: ١٠٠ ريال",
  prtWithdraw: "سحب",
  prtAwaitingLink: "بانتظار الربط",
  prtRequestPayout: "اطلب تحويلاً",
  prtPayoutsListTitle: "طلبات التحويل",
  prtPayoutOk: "أُرسل طلبك — سيُراجَع ويُصرف إلى الحساب المسجّل",
  prtPayoutStPending: "معلّق",
  prtPayoutStApproved: "موافَق عليه",
  prtPayoutStPaid: "صُرف",
  prtPayoutStRejected: "مرفوض",
  prtCommTitle: "عمولتك",
  prtCommBody: "من صافي كلّ دفعة يدفعها المشترك المباشر — طوال سنته الأولى",
  prtChipDirect: "مباشر فقط",
  prtChipHold: "تعليق ٣٠ يوماً",
  prtChipNet: "صافي الإيراد",
  prtActivityTitle: "حركة الأرباح",
  prtNoEarnTitle: "لا أرباح بعد",
  prtNoEarnBody: "عمولاتك المعتمدة ستظهر هنا",
  prtPayoutTitle: "بيانات التحويل",
  prtPayoutMethod: "طريقة التحويل",
  prtNotSet: "غير محدّدة",
  prtVerification: "توثيق الهوية",
  prtRequired: "مطلوب",
  prtCompleteSetup: "أكمل الإعداد",
  prtSetupLater: "يتاح مع فتح الاشتراكات",
  prtTermsTitle: "شروط العمولة",
  prtTermRate:
    "٢٥٪ من صافي الإيراد عن كلّ دفعة يدفعها المشترك خلال أوّل سنة من اشتراكه (الاشتراك السنوي: دفعة واحدة)",
  ...
  weeklyRanksTimes: (n: number) =>
    n === 1
      ...
      : n === 2
        ? "في أوائل الأسبوع مرّتين"
        : n <= 10
          ? `في أوائل الأسبوع ${n} مرّات`
          : `في أوائل الأسبوع ${n} مرّة`,
  ...
  smartListHint: "تمتلئ وحدَها من مكتبتك: اضغط «قائمة ذكيّة» واختر شروطك هنا.",
  ...
  verifySub: "علامةٌ تقول إنّ هذا الحساب يمثّل الشخص أو الجهة المذكورة.",
  verifyNotSold: "التوثيق لا يُباع، ولا يأتي تلقائياً مع Loopz+ أو مع الشراكة — يُقدَّم عليه بشكل مستقلّ ويُراجَع يدوياً.",
  verifyStepChecks: "الشروط",
  verifyChkComplete: "الحساب عامّ ومكتمل (اسم ومعرّف وصورة)",
  verifyChkActive: "نشاط حقيقي خلال آخر ٣٠ يوماً",
  verifyChkActiveN: (have: number, need: number) => `${have} من ${need} أيام نشاط`,
  verifyChkClean: "لا مخالفات نشطة",
  verifyStepKind: "نوع الحساب",
  verifyKindPerson: "شخصية عامة أو صانع محتوى",
  verifyKindOrg: "جهة أو علامة تجارية",
  verifyKindMedia: "منصة إعلامية أو جهة فنية",
  verifyStepProof: "الإثباتات",
  verifyLinked: "الحسابات المرتبطة",
  verifyLinkedNone: "لم تربط أيّ حساب بعد.",
  verifyLinkHint: "اربط حسابك الرسمي بتسجيل الدخول منه — هذا يثبت ملكيّتك له، ولا نطلب صورة هوية.",
  verifyLinkX: "اربط حساب X",
  verifyLinkFacebook: "اربط حساب فيسبوك",
  verifyLinkFailed: "تعذّر الربط — قد يكون المزوّد غير مفعّل بعد.",
  verifyLinksLabel: "روابط حساباتك الرسمية",
  verifyWebsite: "موقع رسمي",
  verifySources: "مصادر تثبت الشهرة أو الصفة",
  verifyReason: "لماذا تطلب التوثيق؟",
  verifySubmit: "إرسال الطلب",
  verifyStatusPending: "قيد المراجعة",
  verifyStatusMoreInfo: "مطلوب معلومات إضافية",
  verifyStatusApproved: "مقبول",
  verifyStatusRejected: "مرفوض",
  verifyReviewTime: "المراجعة يدوية خلال ٣ إلى ٧ أيام عمل.",
  verifyReapply: "يمكن إعادة التقديم بعد ٦٠ يوماً من الرفض.",
  verifyReapplyAt: (d: string) => `يمكنك إعادة التقديم بعد ${d}`,
  verifyRehandle: "تغيير معرّف الحساب (@) يُسقط التوثيق ويستلزم إعادة التقديم.",
  verifyAlready: "حسابك موثَّق.",
  verifyNotEligible: "أكمل الشروط أعلاه أولاً.",
  ...
  apiVerifyCannotApply: "لا يمكن التقديم الآن.",
  apiVerifyReason: "اكتب سببَ الطلب بجملةٍ واضحة.",
...
const en: Dict = {
  ...
  toWatchAction: "To watch",
  toListAction: "To list",
  inListAction: "In a list",
  favoriteAction: "Favorite",
  watchedAction: "Watched",
  redCardAction: "Red card — drop it",
  ...
  invTabPartners: "Loopz Partners",
  invYourLink: "Your invite link",
  invShare: "Share your link",
  invCopy: "Copy link",
  invNextReward: "Your next Loopz+ reward",
  invOf: "of",
  invQualified: "qualified invites",
  invStepHintPre: "Invite 5 friends and get",
  invStepHintReward: "1 month of Loopz+",
  invStatJoined: "Joined",
  invStatCounted: "Activated",
  invStatSubscribed: "Paid",
  invStatRewards: "Rewards",
  invDayUnit: "d",
  invRecent: "Recent invites",
  invViewAll: "View all",
  invEmptyTitle: "No invites yet",
  invEmptyBody: "Share your link to get started",
  invHowTitle: "How rewards work",
  invHow14: "Your friend gets 14 days of Loopz+",
  invHow7: "You get 7 days when they become active",
  invHowSub: "You get 14 more days when they subscribe",
  invFinePrint:
    "A friend becomes active after tracking 5 titles and being active on 3 separate days within the first 14 days · the subscribe bonus activates when subscriptions open · capped at 12 earned months per year",
  invTermsLink: "Terms & eligibility",
  invStJoined: "Joined",
  invStProgress: "In progress",
  invStQualified: "Activated",
  ...
  prtHeroBody: "Earn 25% of the net on every payment your subscribers make — through their whole first year.",
  ...
  prtStep1: "Apply",
  prtStep1Sub: "Tell us where you create",
  prtStep2: "Get approved",
  prtStep2Sub: "We review your profile",
  prtStep3: "Share & earn",
  prtStep3Sub: "Use your personal partner link",
  prtWhoTitle: "Who can apply?",
  prtWhoHead: "Creators, reviewers and active community members",
  prtWho1: "An active Loopz account",
  prtWho2: "A public social profile or channel",
  prtWho3: "Original entertainment content",
  prtReqTitle: "Two requirements before applying",
  prtReqX: "An X account verified on Loopz",
  prtReqPlus: "An active Loopz+ subscription",
  prtReqGo: "Complete it to unlock the application",
  prtSetupTitle: "Complete your partner details",
  prtSetupBody: "Payouts open with payments — and go first to completed profiles.",
  prtRowId: "ID document",
  prtIdPick: "Image or PDF — up to 8MB",
  prtIdDone: "Uploaded — tap to replace",
  prtIdBusy: "Uploading…",
  prtIdErrType: "Image or PDF only",
  prtIdErrSize: "8MB limit",
  prtIdErrUp: "Upload failed",
  prtBankIban: "IBAN (SA…)",
  prtBankName: "Bank name",
  prtBankHolder: "Account holder name",
  prtPhoneField: "Mobile number (05…)",
  prtSaveDetails: "Save details",
  prtDetailsTitle: "Transfer details",
  prtTermsLink: "Partner terms",
  prtReviewNote: "Applications are reviewed individually.",
  prtApplyTitle: "Application",
  prtFieldChannel: "Your main channel or account URL",
  prtFieldContent: "Content type (reviews, news, podcast…)",
  prtFieldPlatforms: "Platforms you publish on",
  prtFieldFollowers: "Followers count — optional",
  prtFieldCountry: "Country",
  prtFieldLanguage: "Content language",
  prtFieldReason: "Why do you want to join?",
  prtTermsAgree: "I agree to the partner program terms",
  prtSubmit: "Submit application",
  prtUnderReview: "Application under review",
  prtReviewBody: "We'll notify you here as soon as it's reviewed",
  prtAppliedAt: (when: string) => `Sent ${when}`,
  ...
  prtStatPaid: "Paid",
  prtStatConv: "Conversion",
  prtEarnLabel: "Available earnings",
  prtCurrency: "SAR",
  prtPendingSuffix: "pending",
  prtMinPayout: "Minimum payout: SAR 100",
  prtWithdraw: "Withdraw",
  prtAwaitingLink: "Awaiting payment link",
  prtRequestPayout: "Request payout",
  prtPayoutsListTitle: "Payout requests",
  prtPayoutOk: "Request sent — it will be reviewed and paid to your registered account",
  prtPayoutStPending: "Pending",
  prtPayoutStApproved: "Approved",
  prtPayoutStPaid: "Paid",
  prtPayoutStRejected: "Rejected",
  prtCommTitle: "Your commission",
  prtCommBody: "Of the net on every payment a direct subscriber makes — through their first year",
  prtChipDirect: "Direct only",
  prtChipHold: "30-day hold",
  prtChipNet: "Net revenue",
  prtActivityTitle: "Earnings activity",
  prtNoEarnTitle: "No earnings yet",
  prtNoEarnBody: "Your approved commissions will appear here",
  prtPayoutTitle: "Payout details",
  prtPayoutMethod: "Payout method",
  prtNotSet: "Not set",
  prtVerification: "Verification",
  prtRequired: "Required",
  prtCompleteSetup: "Complete setup",
  prtSetupLater: "Available when subscriptions open",
  prtTermsTitle: "Commission terms",
  prtTermRate:
    "25% of net revenue on every payment a subscriber makes during their first year (annual plan: one payment)",
  ...
  smartListHint: "Fills itself from your library: tap Smart list and pick your rules right here.",
  ...
  verifySub: "A mark saying this account represents the stated person or organisation.",
  verifyNotSold: "Verification is not sold and does not come with Loopz+ or with partnership — it is applied for separately and reviewed by hand.",
  verifyStepChecks: "Requirements",
  verifyChkComplete: "Public, complete profile (name, handle, picture)",
  verifyChkActive: "Real activity in the last 30 days",
  verifyChkActiveN: (have: number, need: number) => `${have} of ${need} active days`,
  verifyChkClean: "No active violations",
  verifyStepKind: "Account type",
  verifyKindPerson: "Public figure or creator",
  verifyKindOrg: "Organisation or brand",
  verifyKindMedia: "Media outlet or arts body",
  verifyStepProof: "Evidence",
  verifyLinked: "Linked accounts",
  verifyLinkedNone: "You have not linked any account yet.",
  verifyLinkHint: "Link your official account by signing in with it — that proves you own it, and we ask for no ID document.",
  verifyLinkX: "Link X account",
  verifyLinkFacebook: "Link Facebook account",
  verifyLinkFailed: "Could not link — the provider may not be enabled yet.",
  verifyLinksLabel: "Links to your official accounts",
  verifyWebsite: "Official website",
  verifySources: "Sources showing notability or standing",
  verifyReason: "Why are you requesting verification?",
  verifySubmit: "Submit request",
  verifyStatusPending: "Under review",
  verifyStatusMoreInfo: "More information needed",
  verifyStatusApproved: "Approved",
  verifyStatusRejected: "Rejected",
  verifyReviewTime: "Reviewed by hand within 3 to 7 working days.",
  verifyReapply: "You may re-apply 60 days after a rejection.",
  verifyReapplyAt: (d: string) => `You can re-apply after ${d}`,
  verifyRehandle: "Changing your @handle clears verification and requires a new request.",
  verifyAlready: "Your account is verified.",
  verifyNotEligible: "Meet the requirements above first.",
  ...
  apiVerifyCannotApply: "You can't apply right now.",
  apiVerifyReason: "Give a clear reason.",
