...
const ar = {
  ...
  prtYourLink: "رابطك كشريك — كل من يسجّل عن طريقه يُنسب لك",
  prtStatClicks: "نقرة على رابطك",
  prtStatJoined: "انضمّوا عن طريقك",
...
const en: Dict = {
  ...
  prtYourLink: "Your partner link — anyone who signs up through it counts as yours",
  prtStatClicks: "Clicks on your link",
  prtStatJoined: "Joined through you",
