...
const ar = {
  ...
  invYourLink: "رابطك الدائم — كل من يسجّل عن طريقه يُنسب لك",
  invShare: "شارك رابطك",
...
const en: Dict = {
  ...
  invTabPartners: "Loopz Partners",
  invYourLink: "Your permanent link — anyone who signs up through it counts as yours",
  ...
  invStatCounted: "Qualified",
  invStatSubscribed: "Subscribed",
  ...
  invStQualified: "Qualified",
  invStSubscribed: "Subscribed",
