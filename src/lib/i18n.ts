...
const ar = {
  ...
  cpHint:
    "هذه التفضيلات تعمل داخل التوصيات والاستكشاف وحدهما. البحث ومكتبتك والروابط المباشرة لا تتأثر بها إطلاقاً.",
  ...
  setAccount: "الحساب",
  setAccountSub: "اسم المستخدم والبريد والحسابات المرتبطة",
...
const en: Dict = {
  ...
  cpHint:
    "These preferences apply to recommendations and Discover only. Search, your library and direct links are never affected.",
  ...
  setGroupPersonalize: "Personalize",
  ...
  setAccount: "Account",
  setAccountSub: "Username, email and connected accounts",
