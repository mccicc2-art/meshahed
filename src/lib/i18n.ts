...
const ar = {
  ...
  /* 🆕 D-768 (حكم أحمد): دعوةُ الأصدقاء — رابطٌ دائمٌ وعدّادٌ وقائمةُ
     من دخلوا، وكلُّ ٥ دعواتٍ محتسبةٍ شهرُ Loopz+، والمدعوُّ يبدأ بشهرٍ
     هديةً، والاحتسابُ بعد ٣ متابعات */
  setInvites: "دعوة الأصدقاء",
