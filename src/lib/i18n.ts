...
const ar = {
  ...
  deleteAccountDesc:
    "يمحو كل بياناتك نهائياً: المتابعات والمشاهدات والتقييمات والقوائم والصور. لا رجوع بعدها.",
...
const en: Dict = {
  ...
  deleteAccountDesc:
    "Permanently erases all your data: follows, watch history, ratings, lists and images. There is no undo.",
