...
const ar = {
  ...
  browseSortGroup: "الترتيب",
  browseSortTrending: "الأكثر رواجاً",
  browseSortTop: "الأعلى تقييماً",
  browseSortNew: "الأحدث",
  browseReset: "مسح الفلتر",
  browseCount: (n: string) => `${n} عمل`,
  browseMore: "عرض المزيد",
  browseLoading: "جارٍ التحميل…",
  browseEnd: "وصلت إلى نهاية النتائج",
  browseEmpty: "لا نتائج بهذا الفلتر — جرّب تصنيفاً آخر.",
  browseFailed: "تعذّر تحميل النتائج. حاول مرة أخرى.",
  typeSeries: "مسلسل",
  typeMovie: "فيلم",
...
const en: Dict = {
  ...
  browseSortGroup: "Sort",
  browseSortTrending: "Trending",
  browseSortTop: "Top rated",
  browseSortNew: "Newest",
  browseReset: "Clear filter",
  browseCount: (n: string) => `${n} titles`,
  browseMore: "Show more",
  browseLoading: "Loading\u2026",
  browseEnd: "You've reached the end",
  browseEmpty: "Nothing matches this filter \u2014 try another genre.",
  browseFailed: "Couldn't load the results. Please try again.",
  typeSeries: "Series",
  typeMovie: "Movie",
