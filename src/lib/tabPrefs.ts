...
/** هل يخالف هذا التفضيلُ الافتراضَ؟ — نقطةُ الحالة على رمز الأدوات */
export function tabPrefsTouched(surface: TabSurface, prefs: TabPref[]): boolean {
  return serializeTabPrefs(prefs) !== serializeTabPrefs(parseTabPrefs(surface, null));
}
