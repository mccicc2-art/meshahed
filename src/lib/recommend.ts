 ...
 *
 * طلب المالك (9 Aug): «٦٠٪ من اللي قيّمته فوق ٧، و٤٠٪ من اللي شفتها» —
 * حصّتا المتابعات والأنواع صفر، لكن مصدريهما لم يُحذفا: المرحلة الثانية
 * تكمّل منهما حين لا يكفي التقييم والمشاهدة (حساب جديد بلا تقييمات
 * يستحق اقتراحات لا صفاً فارغاً).
 */
export const MIX: Record<Source, number> = {
  rated: 0.6, // ما قيّمه ٨ فأعلى («فوق ٧») — أصدق إشارة، لأنه قالها صراحةً
  follows: 0, // احتياط الإكمال وحده
  recent: 0.4, // ما شاهده — مزاجه الفعلي
  genres: 0, // احتياط الإكمال وحده
};
