...
/** نافذة صفوف «أفضل ١٠» — لكل صفٍّ نافذته (D-099، طلب أحمد): أزرار
    ...
    **وذاك سؤالٌ يجيبه ذيلُ «أفضل ٢٥ هذي السنة» أصلاً** — فنافذتان
    ...
    ⚠️ **وسقطت «سنة» من النوع بعد أن سقط آخرُ فرعٍ يقرؤها** (D-214):
    بقيت دفعةً واحدةً لا أكثر — **الزمنَ الذي كانت فيه فروعُها مكتوبةً في
    `app/` ولمّا تُرفع** (D-028). */
export type RailWin = "week" | "month" | "all";
