 ...
 *
 * 🔑 **وحجّةُ D-617 لم تُنقض، بل تحقّقت بغيرها**: «صفُّ تبويباتٍ بلا
 * أوّلٍ يقف عليه الزائرُ صفحةٌ بلا باب» — **والبابُ صار «المفضّلة»**،
 * فهي وحدَها التي لا تُطفأ. **المتغيّرُ هويّةُ الباب لا وجوبُه.**
 *
 * ⚠️ **و«المفضّلة» ليست في هذا السجلّ عمداً**: **مفتاحٌ لا يُضغط أسوأُ
 * من غيابه** (D-217).
 *
 * 🆕 **لكنها تُعرض في شاشة التخصيص صفّاً بلا مفتاح** (D-663، حكمُ أحمد:
 * «حتى المفضلة التاب خلها موجوده») — **فالسجلُّ يقول «ما يُطفأ»،
 * والقائمةُ تقول «ما يوجد»**، **وهما سؤالان لا سؤال.** ⚠️ **فمن أضافها
 * إلى هذا السجلّ ظنّاً أنه يوحّدهما جعلها تُطفأ** — **وصفحةٌ بلا بابٍ
 * أوّل هي ما منعته D-617 ثم D-658.**
 */
export const HIDEABLE_PROFILE_TABS = ["overview", "activity", "reviews", "lists"] as const;
