...
export const DEFAULT_PROFILE_PREFS: ProfilePrefs = {
  ...
  /* ⚖️ 🆕 **و«المفضّلة» دخلت الافتراضيّ ورأسَه** (D-653، حكمُ أحمد
     ...
     🔴 **ونقضُ حجّةِ D-152 هنا بحجّةٍ لا بحكم**: كانت «إظهارُه هو
     الإعلانُ نفسُه، ومن لم يطلبه لم يعلنه» — **وذاك كان صحيحاً يومَ
     كانت الصفحةُ أقلَّ إعلاناً بكثير.** **واليومَ الصفحةُ نفسُها تعلن
     مكتبتَه كاملةً وتقييماتِه ومراجعاتِه ونشاطَه كلَّه** — **فقائمةُ
     مفضّلتِه أقلُّ إفشاءً من كلِّ ما حولها**، **وحجّةُ خصوصيّةٍ تحرس
     بابَ غرفةٍ جدارُها مفتوح ليست حجّة.**

     🔑 **والعطلُ الذي أظهره حكمُه**: **اسمُ التبويب الأوّل كان يختلف
     بين حسابٍ وحساب** — «المفضّلة» لمن خصّص و«نظرة عامّة» لمن لم
     يخصّص — **واسمان لتبويبٍ واحدٍ في تطبيقٍ واحدٍ خللٌ** (D-145)،
     **وتصميمُه في D-561 سمّاه «المفضّلة» ابتداءً.**

     ⚠️ **وموضعُه الرأسُ لا الذيل**: هو التبويبُ نفسُه (D-561)، **ولا
     أثرَ لموضعه في الرسم** (`sections.favorites = null`) — **لكنّ
     شاشةَ التخصيص تقرأ الترتيبَ نفسَه**، فيُقرأ فيها أوّلاً كما يُرى.
     ⚠️ **ولا يمسّ من خصّص**: `sanitizeProfilePrefs` تُقدّم المحفوظَ —
     **وترتيبٌ اختاره صاحبُه لا يُعاد كتابتُه بنيّةٍ حسنة** (ق٨). */
  order: ["favorites", "shows", "movies", "lists", "ratings"],
  density: "comfortable",
  cards: "full",
