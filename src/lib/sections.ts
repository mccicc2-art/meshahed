 ...
 */
/* 🆕 **وتُصدَّر منذ D-740**: **صفُّ الترايلرات يحتاج القرعةَ نفسَها**
   — **ونسخةٌ ثانيةٌ من خلطِ فِشر-ييتس هي كيف تفترق القرعتان يوماً**
   (القاعدة ٦). ⚠️ **ولا يُستورد هذا الملفُّ من مكوّن عميلٍ قطّ** (انظر
   فوق) — **والمستوردُ الجديدُ `lib/trailers.ts` وهو `server-only`.** */
