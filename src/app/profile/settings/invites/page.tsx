  ...
  return (
    <>
      ...
      {/* ⚖️ 🆕 **٢٥٪ · سنة · ١٠٠ ريال** (D-782، حكمُ أحمد: «خلها أول
          ...
          شُحنت قبلَه بساعة** (D-781).
          🔴 **والخانةُ الوسطى لم تُفرَّغ بل بُدِّلت**: كانت «٣ · أول
          دفعات» — **وهي سقفُ العرض** — **فلمّا تبدّل السقفُ صار تركُها
          كذباً وحذفُها يترك شبكةً بثلثين.**
          🔑 **واسمُ المفتاح `prtValPeriod` لا `prtValLifetime`**:
          **قيمةُ هذه الخانة تبدّلت مرّتين في ساعة** — **فاسمٌ يصف
          موضعَها يبقى، واسمٌ يصف قيمتَها يكذب مع أوّل تعديل.** */}
      <div className={`${settingsCard} grid grid-cols-3 divide-x divide-[color:var(--divider)] rtl:divide-x-reverse text-center`}>
        {(
          [
            ...
            [t.prtValPeriod, t.prtStatPeriod],
