  ...
  return (
    ...
    <div className="fixed inset-x-0 top-16 bottom-0 overflow-hidden flex flex-col">
      ...
      {/* الجدار زينةٌ خالصة فلا يحقّ له حجبُ البطل: طلب TMDB كان يؤخّر رسم
          ...
          يتوسّط الشاشة كلّها ثم يقفز للأعلى لحظة وصول الملصقات — وتتكرّر
          القفزة عند كل تبديل لغة لأن الصفحة تُعاد بناؤها. مساحةٌ محجوزة
          لا هيكلٌ وامض: لا شيء يُرسم فيها، ولا شيء يتحرّك بعدها. */}
