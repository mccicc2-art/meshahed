  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <div className="relative h-[calc(9.5rem+var(--safe-top))] sm:h-[15rem] lg:h-[22rem] xl:h-[25rem] 2xl:h-[27rem] -mx-4 -mt-6 sm:mx-0 sm:mt-0 sm:rounded-3xl overflow-hidden">
