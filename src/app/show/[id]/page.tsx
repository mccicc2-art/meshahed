        ...
        <div className="relative flex gap-4 -mt-24 sm:-mt-28 px-5">
          ...
          <div className="flex-1 min-w-0 self-start pt-0.5">
            ...
            <div className="hero-halo flex flex-wrap items-center gap-x-2 gap-y-1 text-xs sm:text-sm text-foreground/85 mt-1.5">
              ...
              {/* 🆕 **والنوعُ أوّلَ السطر: فيلمٌ أم مسلسل** (D-736، بلاغُ
                  أحمد: «في الأنمي ما هو معقول ما أعرف هذا مسلسل أو فلم»).
                  🔑 **والأنمي هو الذي كشفه**: **بقيّةُ الأعمال يفرزها
                  الملصقُ والاسمُ في ذهن القارئ** — **والأنمي لا**:
                  فيلمُه ومسلسلُه بأسلوب رسمٍ واحدٍ وعالمٍ واحدٍ واسمٍ
                  متسلسل. **وما لا يفرزه الحدسُ يُكتب.**
                  ⚠️ **وأوّلَ السطر لا آخرَه**: **هو أعمُّ ما فيه** —
                  السنةُ والمدّةُ والجنسيّةُ تفاصيلُ عملٍ عرفتَ نوعَه.
                  ⚠️ **ولا سطرَ رابعٌ** (حجّةُ D-419/D-501/D-562 بحرفها):
                  **ترويسةٌ تكبر تدفع القصّةَ خارج الشاشة الأولى.** */}
              <span>{t.typeSeries}</span>
              ...
              {/* 🆕 **والنوعُ الأوّل يذيّل السطر** (D-736، حكمُه بعد أن
                  عُرض عليه الفرقُ بين النوع وكلماتِ الموضوع): **مجّانيٌّ
                  تماماً** — الأنواعُ في ردِّ التفاصيل نفسِه بلغة القارئ،
                  **فلا نداءَ ثانٍ ولا ترجمةَ بأيدينا.**
                  ⚠️ **والأوّلُ وحدَه لا الثلاثة**: **الرقائقُ تحتَه
                  تعرضها كلَّها** — **وسطرُ الهويّة لمحةٌ لا فهرس**،
                  **وثلاثةُ أنواعٍ فيه تدفع الجنسيّةَ إلى سطرٍ ثانٍ**
                  (حجّةُ D-562 بحرفها).
                  🔶 **والتكرارُ مع أوّل رقاقةٍ معلَنٌ ومقبولٌ بحكمه**:
                  **السطرُ يُقرأ قبل أن تصل العينُ إلى الرقائق.** */}
              {tv.genres[0]?.name && (
                <>
                  <span aria-hidden>·</span>
                  <span>{tv.genres[0].name}</span>
                </>
              )}
            </div>
