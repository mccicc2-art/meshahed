...
export function GET(request: Request) {
  ...
  const body = official
    ? [
        ...
        "Disallow: /person/",
        "Disallow: /talk/",
        // 🔴 🆕 D-931: **المحسِّنُ ليس سطحاً يُفهرَس** — كلُّ صورةٍ نريدها في
        // البحث تُقدَّم من `/i/` أصلاً (D-841)، وروابطُ `/_next/image` القديمة
        // كلّفت ٣٦ ألفَ تحويلٍ في يومٍ لزواحفَ لا ترى. المهذَّبُ يقرأ هذا،
        // والباقي يحوّله الوسيط (`proxy.ts`) إلى الممرّ.
