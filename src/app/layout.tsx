  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col">
        {/* شاشةُ الإقلاع للمتصفّح العادي — في التطبيق المثبّت تمنعها CSS
            قبل أول رسم لأن iOS عرض صورته الأصلية بالفعل؛ وجود الشعارين
            هو مصدر برق التسليم. في المتصفّح تُرسم مع أول بايت، ويزيلها
            سكربت الذيل بعد الترطيب. ولمن عطّل جافاسكربت: تُخفى فوراً
        ...
        <BottomNav
          ...
          signedIn={signedIn}
        />
        {/* 🔴 🆕 **إزالةُ شاشة الإقلاع في المتصفّح — عند الجاهزيّة لا عند التحليل**
            (D-529، تسجيلُ أحمد للإقلاع البارد: «شعاران متداخلان عند
            ~١٫٠٣ث مع ظهور App Shell خلف شاشة الإقلاع»).

            التطبيق المثبّت لا يمرّ من هذا المسار الآن: CSS تخفي شاشة
            HTML قبل أول رسم وتترك splash النظام وحدها؛ وهذا هو إصلاح
            التداخل الذي لا تستطيع إزالةٌ بعد الترطيب منعه.
