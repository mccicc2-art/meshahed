...
export function QueueOrderButton({
   ...
   *
   * ⚖️ 🆕 **والكلمةُ صارت «أعد الترتيب» لا «الكل»** (D-868): **مبدأُ
   * D-624 كلمةٌ لا علامة، وقد بقي** — **والذي سقط اختيارُ الكلمة.**
   * 🔴 **لأن «الكل» صارت لها معنًى واحدٌ في الرئيسية**: «أرِني كلَّ
   * عناصر القسم» — **وزرٌّ يلبسها ويفتح ورقةَ ترتيبٍ يكرّر علّةَ
   * D-863 بعينها** (كلمتان متطابقتان لفعلين مختلفين).
   * 🔑 **وصارت الكلمةُ هي `aria-label` نفسَها**: **ما يُنطق هو ما
   * يُقرأ** (D-142).
   */
  word?: string;
}) {
