...
export function PosterRail({
  ...
  bare?: boolean;
  /**
   * ⚖️ 🆕 **مقبولٌ ولا يُقرأ — لعمرِ ترقيةٍ واحدة** (D-028): كان يلصق
   * رأسَ القسم تحت الترويسة (D-464)، **ونقضُ D-464 مسجَّلٌ بطلب أحمد
   * ١٩ أغسطس ليلاً بنصّه: «ألغِ تثبيت عناوين الأقسام… يتحرك عنوان
   * القسم طبيعيًا مع محتواه ولا تتراكم العناوين فوق بعضها».**
   * المستدعون يُنظَّفون في دفعة `app`، ثم يُحذف المعامل.
   */
  stickyHead?: boolean;
  ...
  return (
    <section className={className}>
      {/* ⚖️ رأسُ القسم يتحرّك مع محتواه — لا لصقَ (نقضُ D-464، طلبُ
          أحمد ١٩ أغسطس: «يختفي عند تجاوزه، لا يتوقف أسفل الهيدر») */}
