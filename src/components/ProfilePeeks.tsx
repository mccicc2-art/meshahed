...
export function FollowCountButton({
  ...
  const body = compact ? (
    <>
      {/* ⚖️ 🆕 **الوجهُ المضغوطُ عاد رمزاً وعدّاً بلا كلمة — وبعدَّيه**
          (D-621، حكمُه على السطر: «ضيف المتابعون كذا: أيقونتين بدون
          نصّ، وحدة الي يتابعوني والثانية الي أتابعهم») — **عودةُ
          رمزَي D-572 بحجّتهما الأولى**: بلا كلمةٍ لا يفرّق العدَّين
          إلا رمزان مختلفان — **جماعةٌ لمن يتابعونني، وشخصٌ عليه صحٌّ
          لمن أتابعهم** (أنا فعلتُ ذلك). وكلمةُ D-618 غادرت بحكم
          صاحبها، والمعنى الكامل في `aria-label` و`title` (D-138).
          والمقاسُ ١٤ — مقاسُ سطرِ التعريف الثانويّ (D-619). */}
      <Icon name={dir === "followers" ? "people" : "person-check"} size={14} />
