 ...
 *
 * **١ · خطٌّ فاصل لا إطار** — **وقد شُحنت أوّلاً بإطارات ورُدَّت.**
 * الحجّةُ التي بُنيت عليها (قاعدةُ D-217: الإطارُ لغرضٍ مستقلّ والخطُّ
 * لأدوارِ حديثٍ واحد) **كانت تصنيفاً صحيحاً وحكماً خاطئاً**: صفحةٌ من
 * بطاقاتٍ مؤطَّرة متتالية **تُقرأ شبكةً لا قائمة**، ولكلِّ صفٍّ حدّان —
 * حدُّه وحدُّ جاره — **فيصير في الشاشة ضجيجٌ بلا معلومة.**
 *
 * **وحكمُ أحمد: «بدون الإطارات، الخطّ الفاصل أفضل».** والقاعدةُ الأصحّ
 * التي تُستخلص: **الإطارُ يُشترى بحاجةٍ لا بتصنيف** — يُوضع حين تتداخل
 * الأغراض بصرياً فلا يُعرف أين ينتهي أحدها، **لا كلَّما كانت مستقلّة.**
 * **وثلاثةُ أسطحٍ في التطبيق اليوم بخطٍّ فاصل واحد**: `WorksTalk` ·
 * `TalkThread` · وهذا. **وشكلٌ واحدٌ للقائمة كلِّها هويّة.**
 *
