        ...
        extra={
          /* 🆕 **والصفُّ صار مكوّناً مشتركاً** (تتمّةُ المرحلة ٨):
             **المكتبةُ تطلب الصفَّ نفسَه**، **ونسخةٌ ثانيةٌ منه خطأٌ
             ...
             🆕 **وصفرُ رقائقٍ يعني ألّا يُمرَّر `extra` أصلاً** (D-591،
             بلاغُ أحمد بلقطة: «وهذا الهامش كذلك احذفه»): المكوّنُ يرسم
             `null` حين لا فلتر، **لكنّ العنصرَ نفسَه صادقٌ في شرط
             `extra ?` فكان غلافُه `pt-3 pb-2` يُرسم فارغاً** — عشرون
             بكسلاً معتمةً بين الشريط وأوّل عنوان. **والشرطُ عند من يملك
             العدَّ** (`chips.length`)، كعدّاد الزرّ نفسِه (D-577). */
