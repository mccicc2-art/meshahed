...
export function SpoilerText({
  ...
  locale: Locale;
  /**
   * **سببُ الحجب — ويختلف باختلاف من حجب** (D-271): **مشاركةُ عضوٍ تُحجب
   * لأنه هو أعلنها** فيُقال «حدَّده كاتبُه» — **وسطرٌ يقول «يكشف أحداثَ
   * الحلقة» فوق كلام إنسانٍ يعِد بما لا يعرفه أحد** (D-216).
   *
   * ⚖️ **وسقط الافتراضيُّ في D-287** (طلبُ أحمد على لقطة نشرة: «هذي
   * العبارة احذفها، مو لازم تشرح»): كانت النشرةُ تقول «يكشف أحداثَ
   * الحلقة» **بجانب زرٍّ مكتوبٌ عليه «اعرض الحرق»** — **وكلمةٌ تكرّر ما
   * قرأه القارئُ للتوّ ضجيج** (D-224).
