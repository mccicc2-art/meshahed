  ...
  return (
    <span
      ...
      style={{
        ...
        direction: "ltr",
        /* ⚖️ 🆕 **ورُفع القرصُ ٠٫٠٢em** (D-859، بلاغُ أحمد بلقطتين
           محوَّطتين: «ماهي ماشي في نفس سطر الكلمة بحيث تكون متوسطة
           الارتفاع بالضبط») — **مقيسٌ لا مستنتَج**: مركزُ القرص في
           لقطتَيه نازلٌ عن مركز قامة الاسم ‎+٠٫٠١٧ و‎+٠٫٠٢٦em
           (بكسلٌ ونصفٌ على شاشة جوّالٍ ‎3×‎)، وفي قياس الصفحة الحيّة
           ‎+٠٫٥px عند خطّ ٢٤. **والوحدةُ em من خطِّ الاسم** فيصحّ
           التصحيحُ في كلِّ مقاسٍ بالنسبة نفسِها. */
