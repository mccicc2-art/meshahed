...
export function TitleHero({
  ...
  title: string;
  /**
   * ⚖️ 🆕 **سطرُ «نقاشات مسلسل …» عاد** (D-310، سؤالُ أحمد: «وين
   * راحت؟») — **حذفُه في D-304 كان قراءةً خاطئةً لشطبةٍ في لقطته.**
   * **وما حُذف بقراءةٍ خاطئة يعود بنصّ صاحبه** (D-161).
   */
  sub?: React.ReactNode;
  ...
  return (
    ...
    <header className="relative -mt-6 -mx-4 h-[16svh] min-h-[144px] max-h-[180px] overflow-hidden bg-surface-2">
      ...
      {/* 🆕 **الصفُّ يُحاذى من الأعلى لا من الوسط** (D-288): السهمُ صار
          ...
          أحمد بـ«ارفعه فوق». */}
      {/* ⚖️ 🆕 **وعاد الاسمُ إلى جانب الملصق** (D-310، نصُّ أحمد على
          لقطة D-304: «هنا حصلت لخبطة!! كيف اسم المسلسل طلع فوق
          البوستر؟») — **قراءتي للدائرة الحمراء في D-304 كانت خاطئة،
          والنقضُ يُسجَّل باسمه**: الاسمُ فوق الشريط قُرئ منفصلاً عن
          هويّة العمل، **والاسمُ يجاور صورتَه** (D-256: حيث لا وجه
          فالملصقُ هو الهويّة — **والاسمُ كذلك يسكن جواره**). */}
