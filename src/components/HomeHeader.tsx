      ...
      {coverUrl && (
        <div
           ...
           **فما صغُر مقاسٌ بل نسبة**، وهو حرفُ D-836.
           ...
           📐 **والرقمان مقيسان على الخطّ الحيّ بعد الرفع** لا مقدَّران:
           **صفُّ الترحيب ينتهي عند ١٦٥ والبطاقةُ تبدأ عند ١٧٩** —
           **فالخطُّ الصلبُ ١٧٠ بينهما** (وهو تعريفُ الخطِّ الثاني في
           D-556 حرفاً)، **والصندوقُ ٢٢٤ يدخل تحت البطاقة**
           **فيختفي ذيلُ الذوبان خلف سطحها الصمّاء** ولا حافّةَ تُرى.
           🔴 **و١٦٠ كانت خطأً رفعتُه**: وقعت داخل الصفِّ لا تحته،
           **فبدأت الصورةُ تذوب تحت الصورة الشخصيّة بخمسة بكسلات** —
           **رقمٌ يخالف القاعدةَ التي كتبتُها فوقه بسطر.**

           ⚖️ 🆕 **ثمّ ارتفع الأربعةُ معاً بحكمه** (D-853: «كبّر الصورة
           والاسم شوي») — **والأرقامُ مشتقّةٌ لا مذوقة**: **الدائرةُ
           ٤٤→٥٦ فصندوقُها ٥٢→٦٤ (+١٢)**، **و٧٢→٨٨ فصندوقُها ٨٠→٩٦
           (+١٦)** — **وصفُّ الترحيب ارتفاعُه ارتفاعُ الدائرة** (فهي
           أطولُ من كتلة الاسم) — **فزاد الصندوقُ والخطُّ الصلبُ
           بمقدارِه بالضبط**: ١٥٢→١٦٤ و١٢٣→١٣٥ · ٢٢٤→٢٤٠ و١٧٠→١٨٦.
           🔑 **وهذا هو نفعُ المتغيّرَين**: **رقمٌ واحدٌ يتحرّك فيتحرّك
           القناعُ معه** — **ولولاهما لقُصّت الصورةُ عند كلِّ تكبير.** */
          className="pointer-events-none absolute inset-x-0 top-0 overflow-hidden [--cover-h:10.25rem] [--cover-solid:135px] lg:[--cover-h:15rem] lg:[--cover-solid:186px]"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <AccountIdentity
              ...
              className="text-20 lg:text-22 font-bold leading-tight"
            />
