...
/**
 * **قناعُ ذوبان الصورة** — تامّةٌ ثمّ تتلاشى، فلا حافّةَ قاطعة.
 *
 * ⚖️ 🆕 **٦٢٪ → ٨٣٪** (D-551، بلاغُ أحمد: «الغلاف يحتاج ينرفع شويّ فوق
 * لمنتصف الكارد مع ظلّ شويّ»).
 *
 * 🔑 **والعلّةُ لم تكن في الحجاب بل في القناع** — **وهذا ما كشفه
 * القياس**: الحجابُ ينتهي عند **١٩٩px** وهو **منتصفُ بطاقة الأرقام
 * بالضبط** (البطاقةُ ١٧٣→٢٢٥ على آيفون بـ`--safe-top: 47`)، **فكان
 * موضعُه صحيحاً منذ D-543.** **والذي يخذل هو الصورة**: كانت تامّةً إلى
 * **١٤٨px وحدها** — **أي أنها تبدأ الذوبانَ فوق البطاقة لا عندها** —
 * **فتموت قبل أن تصل، ويُقرأ الغلافُ منتهياً تحت صفِّ الترحيب.**
 *
 * **و٨٣٪ من ٢٣٩ = ١٩٨٫٤** — **منتصفُ البطاقة، مشتقٌّ من القياس لا
 * مذوق**: يتغيّر ارتفاعُ صفٍّ فوقها يوماً فيُعاد اشتقاقُه.
 */
const COVER_FADE = "linear-gradient(180deg, #000 0%, #000 83%, transparent 100%)";
    ...
    {coverUrl && (
      ...
      >
        ...
        <div
          ...
          /* ⚖️ 🆕 **والحجابُ صار بطول الغلاف نفسِه** (D-551، شطرُ «مع
             ظلّ شويّ»): **كان ينتهي عند منتصف البطاقة بالضبط** —
             **وكان ذلك صحيحاً حين كانت الصورةُ تموت قبله.** **والآن
             وقد صارت الصورةُ حيّةً إلى المنتصف، فما تحته كان سيقع على
             فنٍّ عارٍ بلا ظلّ** — **ورقمٌ أبيضُ على صورةٍ مجهولةِ
             الألوان يُقرأ في غلافٍ ويختفي في آخر** (D-501).

             **والنسبُ نسبُ أحمد بحرفها** — والذي تغيّر الوعاءُ لا
             الوصفة: على ٢٣٩px تصير ٩٦٪ عند الحافّة العليا، **و٨٢٪ عند
             قاع الشريط**، **و٤٢٪ تحت صفِّ الترحيب**، **و~٢٤٪ عند
             منتصف البطاقة — وهو «الظلُّ الشويّ» بعينه** — **ثمّ صفرٌ
             حيث تذوب الصورةُ نفسُها.** **فيموت الظلُّ مع الفنِّ لا
             قبله.** */
          style={{ height: "calc(var(--safe-top) + 12rem)", background: COVER_SCRIM }}
        />
      </div>
    )}
