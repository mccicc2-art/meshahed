...
/* ⚖️ 🆕 **ثمّ استوى الظلامُ كلُّه** (D-613، حكمُ أحمد بلقطةٍ خطَّط
   ...
   مسطّحةً على الحزام كلِّه** — وهي قيمةُ صفِّ الأيقونات التي لم تُمسّ
   في كلِّ المراجعات، فالمقروءُ يبقى مقروءاً والصورةُ خلف الحزام
   بظلٍّ واحدٍ لا بقعَ فيه — **والذوبانُ إلى الصفر بعد `+118` باقٍ**
   فلا حافّةَ تُرسم فوق خلفيّة الصفحة. */
const COVER_SCRIM =
  "linear-gradient(180deg, rgba(0,0,0,0.82) 0," +
  " rgba(0,0,0,0.82) calc(var(--safe-top) + 118px)," +
  " rgba(0,0,0,0) 100%)";
