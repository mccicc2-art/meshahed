          ...
          <div className="flex flex-wrap items-center gap-2 mb-4">
            {pick && (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-border px-3.5 py-2 text-[13px] font-semibold text-muted hover:text-foreground transition"
              >
                <Icon
                  name="chevron-down"
                  size={14}
            ...
            {cover && (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border border-border px-3.5 py-2 text-[13px] font-semibold text-muted hover:text-foreground transition disabled:opacity-50"
              >
