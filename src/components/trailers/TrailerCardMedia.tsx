 ...
 * أيِّ مشغّل**: الغلافُ دائمُ الحضور (لا شاشةَ سوداء أبداً)، والمشغّلُ
 * الواحدُ طبقةُ المتحكّم تعتليه حين يثبت الرسم.
 *
...
export function TrailerCardMedia({
  ...
  return (
    <div ref={area} className="relative aspect-video w-full overflow-hidden bg-surface-2">
      {/* الغلافُ حاضرٌ دائماً — طبقةُ المتحكّم تظهر فوقه عند أوّل إطارٍ متحرّك */}
      {backdrop ? (
        <Image
          src={backdrop}
          alt=""
      ...
      {/* زرُّ الصوت — للبطاقة النشطة وحدَها، والأيقونةُ من الحالة المُتحقَّقة */}
      {isActive ? (
        <button
          type="button"
