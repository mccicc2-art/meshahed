...
/* نجمة TMDB الزرقاء **حُذفت** (D-132 ينقض D-112).
   أُضيفت احتياطاً لما لا تقييم IMDb له، فجاءت الانتقادات على أرقامٍ لا
   تطابق ما يعرفه الناس: TMDB تعطي ٩٫٣ لعملٍ تقييمه الحقيقي ٧٫٨، والشعار
   المختلف لم يمنع القارئ من قراءة المقياسين مقياساً واحداً. حُذف المكوّن
   ولم يُترك بلا مستخدم — الشيء المتروك يعود. */
