 ...
 *
 * ================= 🆕 D-311 — «هذا الأسبوع» عادت بصدقها ==============
 *
 * **العبارةُ سقطت يومَ D-291 عمداً** لأن `title_talk_rooms` كانت تُرجع
 * عدَّ العمر كلِّه، **وعنوانٌ يقول «هذا الأسبوع» فوق رقمٍ عمرُه سنةٌ هو
 * الرقمُ الذي لا يستطيع أحدٌ مراجعتَه** (D-219). **والهجرةُ ٩٦ أعطت
 * الدالّةَ `posts_week` بمرساة سبت الرياض نفسِها** (D-265) — فعاد
 * العنوانُ والرقمُ يملكان النافذةَ معاً (`weekly` على البطاقة)،
 * **والاختيارُ نفسُه صار بالعدّ الأسبوعيّ** (`pickTalkedAboutRoom`).
 *
 * **ودَينا D-273 قُفلا معاً في ٩٦**: «N مشاركة» صارت تعدّ كلامَ الناس
 * وحدَه (`kind is null`) — **هنا وفي تبويب «نقاش» بلا لمسةٍ ثانية**
 * (D-261: العدُّ يملكه موضعٌ واحد).
 *
...
export function TalkedAboutWork({
  ...
  return (
    <BoardSection icon="comment" tone={SECTION_TONE.talked} title={t.peopleBoardTalked}>
      ...
      <TalkRoomCard room={room} locale={locale} hero weekly />
    </BoardSection>
  );
}
