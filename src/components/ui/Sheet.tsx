...
/** الإطار المشترك — لونُ الهوية، ويتبع الثيم (D-177) */
const FRAME =
  "sheet-pop relative flex flex-col rounded-sheet border-2 border-accent bg-[color:var(--elevated)] shadow-2xl overflow-hidden";
