...
export function HeaderTools({ locale }: { locale: Locale }) {
  ...
  return (
    <Link
      ...
      className="absolute top-[calc(2*var(--safe-top)+0.75rem)] end-3 grid place-items-center w-11 h-11 rounded-full border border-border overflow-hidden text-foreground shadow-[0_10px_30px_rgba(0,0,0,0.55)] hover:border-accent/60 active:scale-95 transition"
    >
