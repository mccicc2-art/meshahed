...
export function ActivityFeed({
  ...
  /* ============ الترشيحُ — واحدٌ لا ثلاثة (D-280) ============

     **سقطت D-240 كاملةً**: «لك» و«الأكثر تفاعلاً» حُذفتا، **والخطُّ زمنٌ
     خالص**. **والحجّةُ رقمٌ لا ذوق** — «لك» تطرح صفّين من أربعةٍ وأربعين
     وتكلّف ٥٤px من الرأس اللاصق دائمةً (`app/people/page.tsx`).

     **وبقي ترشيحٌ واحدٌ لأنه إعدادٌ لا خيارُ عرض:** «أظهِر من لا
     أتابعهم» (D-255) — **يُضبط مرّةً ويسري على الخطّ كلِّه**، لا يُطفأ
     في رقاقةٍ ويشتغل في أخرى. */
  /* **ترشيحُ الغرباء** (D-255، طلبُ أحمد) — **وكان يوماً يشمل «لك»
     أيضاً بنصّه «حتى FOR YOU»**، ثم صار الخطُّ واحداً فصار المفتاحُ
     ترشيحَه كلَّه (D-280). **والدرسُ الذي بقي من يومها:** مفتاحٌ اسمُه
     «أظهِر من لا أتابعهم» **لا يُطفأ في رقاقةٍ ويشتغل في أخرى** —
     **ومفتاحٌ لا يعمل في العرض الافتراضيّ لا يعمل عملياً.**
