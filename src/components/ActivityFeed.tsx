...
export function ActivityFeed({
  ...
  /* 🔴 D-900 (أحمد، ٣ سبتمبر: «أبي أشوف آراء المجتمع بس ما يطلع لي»):
     **المفتاحُ «أظهِر الغرباء» وهو مفتوحٌ كان يكذب** — يَعِد بالغرباء
     ويُبقي مرشِّحَ D-283 (صديقٌ، أو غريبٌ عن عملٍ في مكتبتك)، فغريبٌ
     يكتب عن عملٍ لا تتابعه لا يظهر أبداً مهما فُتح المفتاح، **والخطُّ
     يُقرأ «لا أحدَ يكتب»** في مجتمعٍ يكتب. **فصار المفتاحُ هو الحكم**
     (D-217: أداةٌ تعد بما تعطي): مفتوحٌ ⇒ المجتمعُ كلُّه كما يراه
     الزائر (D-629)؛ مغلقٌ ⇒ دائرتُك وحدَها (D-255) — **ومرشِّحُ مكتبةِ
     D-283 لم يعد له موضعٌ بين الحالتين**: كان يُسقط من الحالة المغلقة
     أصلاً ويُضيّق المفتوحةَ خلافاً لوعدها. ⚖️ نقضٌ مُعلَن لـD-283
     بحكم أحمد نفسِه؛ الرجوعُ سطرٌ واحد. */
  let shown =
    guestViewer || showStrangers
      ? rows
      : rows.filter(
          (r) =>
            r.kind === "news" ||
