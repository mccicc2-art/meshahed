...
export function BottomNav({
  ...
  if (
    /* ⚖️ 🆕 **و`/login` سقطت من قائمة الإخفاء** (D-628، بلاغُ أحمد:
       «إذا رحت تبويب تسجيل الدخول ما أقدر أرجع — التبويب يختفي»):
       حجّةُ الإخفاء كانت أن صفحةَ الدخول شاشةُ عتبةٍ لا تنقّلَ فيها —
    ...
    /* 🆕 **وملفُّ العضو** (D-643، بحكمه): **زيارةُ ملفٍّ رحلةٌ لها بدايةٌ
       ...
       الخروج سهمُ الرجوع في غلافه.**
       ⚠️ **والثمنُ يُقال**: من كان في ملفِّ عضوٍ لا يقفز إلى «اكتشف»
       بضغطة، **بل يرجع أوّلاً.** **وهو الثمنُ نفسُه الذي قبلناه في
       الإعدادات**، ويُنقض بكلمةٍ إن ثقل. */
